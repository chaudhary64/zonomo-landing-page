    ...
    return (
        <div className="md:grid md:grid-cols-2 max-w-4xl bg-white mx-4 md:mx-auto rounded-xl">
            ...
            <div className="relative flex items-center justify-center">
                <button className="cursor-pointer absolute top-6 right-6 bg-gray-200 rounded-full p-2.5" aria-label="Close" onClick = {onClose}>
                ...
                <div className="max-md:py-20 px-6 md:px-10 text-center">
                    <h1 className="text-3xl font-bold">
                        <span className="text-blue-600">Don’t miss out</span> <span className="text-black">on our discounted products.</span>
                    </h1>
