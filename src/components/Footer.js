  ...
  return (
    <footer className="bg-gray-50 text-gray-700">
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
        ...
        <div>
          <div className="flex items-center space-x-2 mb-4">
            <div className="bg-black text-white text-xs font-bold px-2 py-1 rounded">UC</div>
        ...
        <div>
          ...
          <ul className="space-y-1">
            <li><a href="#" className="hover:underline">UC reviews</a></li>
        ...
        <div>
          ...
          <a href="#" className="hover:underline">Register as a professional</a>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-3 mb-4">
            <a href="#"><img src="/icons/twitter.svg" alt="Twitter" className="h-6 w-6" /></a>
            ...
            <a href="#"><img src="/icons/linkedin.svg" alt="LinkedIn" className="h-6 w-6" /></a>
          </div>
          <div className="space-y-2">
            <a href="#"><img src="/badges/appstore.png" alt="App Store" className="h-10" /></a>
            <a href="#"><img src="/badges/googleplay.png" alt="Google Play" className="h-10" /></a>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-200 text-xs text-gray-500 py-4 px-6 text-center">
        ...
        <p>© Copyright 2025 Urban Company Ltd. (formerly known as UrbanClap Technologies India Limited) All rights reserved. | CIN: U74140DL2014PTC274413</p>
      </div>
    </footer>
  );
}
