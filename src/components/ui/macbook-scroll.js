...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className=" flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-50">
      <motion.h2
        style={{
        ...
        {title || (
          <span className="text-5xl font-bold text-neutral-800 dark:text-black">
            We will be <span className = "underline decoration-gray-600">Live</span>  <br /> Soon
          </span>
        )}
      </motion.h2>
      {/* Lid */}
