      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid max-w-6xl grid-cols-1 px-20 mx-auto mt-12 text-center sm:px-0 sm:grid-cols-2 md:mt-20 gap-x-8 md:grid-cols-4 gap-y-12 lg:gap-x-16 xl:gap-x-20">
          ...
          <div>
            ...
            <p className="mt-2 text-base font-normal text-gray-600 font-pj">
             Heads user experience and system design, creating smooth and reliable booking flows for customers and
professionals.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-base font-normal text-gray-600 font-pj">
              Architect of Zonomo’s platform infrastructure, focused on building
              a scalable and secure service marketplace.
            </p>
          </div>
        </div>
